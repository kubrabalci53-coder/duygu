...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FFFDF9] via-[#FFF8EE] to-[#FEF2E8] text-stone-800 flex flex-col selection:bg-amber-300 selection:text-amber-950 relative overflow-x-hidden">
      ...
      {/* Top Navigation Bar with Logo, Slogan & Tabs */}
      <Navbar
        activeTab={activeTab}
          ...
          <div className="space-y-6 max-w-4xl mx-auto">
            <div className="bg-white rounded-3xl p-8 border border-stone-200 text-center space-y-4 shadow-xs">
              ...
              <h2 className="text-2xl font-extrabold text-stone-900 font-heading">
                Moral & Gülümseme Köşesi
              </h2>
              <p className="text-sm text-stone-500 max-w-md mx-auto">
                Bazen hepimiz yorulur ya da üzülebiliriz. Nefes egzersizleri, sevimli karikatürler ve neşeli fıkralarla moralini yükseltmek için butona tıkla!
              </p>
              <button
                onClick={() => openCheerUpModal('uzgun')}
                className="px-6 py-3 rounded-2xl bg-gradient-to-r from-orange-600 to-amber-600 text-white font-extrabold text-sm shadow-md hover:scale-105 transition-all cursor-pointer"
              >
                Gülümseme & Rahatlama Aracını Aç ✨
              </button>
            </div>
          </div>
        )}
